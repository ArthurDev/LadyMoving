...
<script type="text/javascript">
	$("#toolspanelcontent").animate( {ldelim}"left": -$("#toolspanelcontent").width(){rdelim} ).addClass("inactive");
	$("#toolspanel .pn-button").click(function(){ldelim} 
		...
		{rdelim}else {ldelim}
			$("#toolspanelcontent").animate( {ldelim}"left": -$("#toolspanelcontent").width(){rdelim} ).addClass("inactive").removeClass("active");
